...
downloads:
    - <a target="_blank" class="download button" href="https://github.com/ElunaLuaEngine/Eluna/blob/master/docs/INSTALL.md">Installation guide</a>
    - <a target="_blank" class="download button" href="http://elunaluaengine.github.io/">API documentation</a>
    - <a target="_blank" class="download button" href="https://github.com/ElunaLuaEngine/Eluna">Eluna source</a>
    - <a target="_blank" class="download button" href="https://github.com/ElunaLuaEngine/ElunaTrinityWotlk">TrinityCore WotLK with Eluna</a>
    - <a target="_blank" class="download button" href="https://github.com/ElunaLuaEngine/Scripts">Example scripts</a>
---
